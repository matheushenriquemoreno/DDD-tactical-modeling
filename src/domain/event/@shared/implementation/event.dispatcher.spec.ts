...
import SendEmailWhenProductsIsCreatedHandler from "../../product/handler/send-email-when-product-is-created.handler";
import ProductCreatEvent from "../../product/product-created.event";
